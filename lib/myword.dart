...
class MyWord extends ConsumerWidget {
  const MyWord({super.key, required this.word});
            ...
            child: Column(
                children: [
                  ...
                  Container(
                    ...
                    height: 50,
                    child: Center(child: Text('De : ${word.author}', style: TextStyle(fontSize: 20),)),
                  ),
//------------------------------------textbox------------------------------------------
                  Container(
                    width: MediaQuery
